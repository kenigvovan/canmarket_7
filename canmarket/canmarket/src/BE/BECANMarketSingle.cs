...
namespace canmarket.src.BE
{
    public class BECANMarketSingle : BEMarket
    {
        ...
        protected override MeshData getOrCreateMesh(ItemSlot slot, int index)
        {
            ...
            if (meshSource != null)
            {
                mesh = meshSource.GenMesh(slot, (this.Api as ICoreClientAPI).BlockTextureAtlas, this.Pos);
            }
            if (mesh == null)
            {
                ...
                else if (slot.Itemstack.Class == EnumItemClass.Block)
                {
                    ...
                    {
                        Dictionary<string, MultiTextureMeshRef> clutterMeshRefs = ObjectCacheUtil.GetOrCreate<Dictionary<string, MultiTextureMeshRef>>(capi, (slot.Itemstack.Block as BlockShapeFromAttributes).ClassType + "MeshesInventory", () => new Dictionary<string, MultiTextureMeshRef>());
            ...
            else if (slot.Itemstack.Collectible.Code.Path.Contains("axe-"))
            {
            ...
            else if (slot.Itemstack.Collectible.Code.Path.Contains("armor-legs"))
            {
                mesh.Scale(new Vec3f(0.5f, 0.5f, 0.5f), 0.65f, 0.65f, 0.65f);
                mesh.Rotate(new Vec3f(0.5f, 0.5f, 0.5f), 0, 0f, -1.6f);
                mesh.Translate(-0.15f, -0.2f, -0.09f);
            }
            else if (slot.Itemstack.Collectible.Code.Path.Contains("armor-head"))
            {
            ...
            else if (slot.Itemstack.Collectible.Code.Path.Contains("armor-body"))
            {
                mesh.Scale(new Vec3f(0.5f, 0.5f, 0.5f), 0.75f, 0.75f, 0.75f);
                mesh.Rotate(new Vec3f(0.5f, 0.5f, 0.5f), 0, 0f, -1.6f);
                mesh.Translate(-0.5f, -0.25f, 0.03f);
            }
            else if (slot.Itemstack.Collectible.Code.Path.Contains("book"))
            {
                mesh.Scale(new Vec3f(0.5f, 0.5f, 0.5f), 0.75f, 0.75f, 0.75f);
                mesh.Rotate(new Vec3f(0.5f, 0.5f, 0.5f), 0, 0f, -1.6f);
